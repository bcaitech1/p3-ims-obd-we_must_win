...
def train(args):
    ...
    train_transform = A.Compose([
        ...
        A.Cutout(num_holes=30, max_h_size=20, max_w_size=20, p=0.5),
    ...
    # criterion = loss_fn()
    criterion = loss_functions.CEDiceLoss(mode='multiclass')
    ...
    # scheduler = NoamLR(optimizer, warmup_steps=5)

    wandb.init(project='p3seg', config={
