model = dict(
    ...
    neck=[
        dict(type="FPN", in_channels=[256, 512, 1024, 2048], out_channels=256, start_level=1, add_extra_convs="on_output", num_outs=5),
        dict(
            type="SEPC",
            out_channels=256,
            stacked_convs=4,
    ...
    test_cfg=dict(
        ...
        max_per_img=100,
        fusion_cfg=dict(type="soft_vote", scale_ranges=[(96, 10000), (64, 10000), (0, 10000), (0, 10000), (0, 256)]),
    ),
)
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(667, 400), (1000, 600), (1333, 800), (1667, 1000), (2000, 1200)],
        flip=True,
        transforms=[
...
lr_config = dict(policy="step", warmup="linear", warmup_iters=1000, warmup_ratio=0.001, step=[16, 19])
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", init_kwargs=dict(project="pstage-3-od", name="universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco_test_vote")),
    ],
)
custom_hooks = [dict(type="NumClassCheckHook")]
dist_params = dict(backend="nccl")
log_level = "INFO"
load_from = "/opt/ml/pstage_3/mmdetection/pretrained/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco_test_vote.pth"
resume_from = None
workflow = [("train", 1)]
tta_flip = True
...
seed = 42
gpu_ids = [0]
work_dir = "./save_dir/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco_test_vote"
