...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(project="pstage-3-od", name="htc_x101_64x4d_fpn_dconv_c3-c5_mstrain_400_1400_16x1_20e_coco_no_seg_with_focal"),
        ),
    ],
)
    ...
    roi_head=dict(
        ...
        bbox_head=[
            dict(
                ...
                loss_cls=dict(type="FocalLoss", gamma=2.0, loss_weight=1.0),
            ...
            dict(
                ...
                reg_class_agnostic=True,
                loss_cls=dict(type="FocalLoss", use_sigmoid=True, gamma=2.0, loss_weight=1.0),
                loss_bbox=dict(type="SmoothL1Loss", beta=1.0, loss_weight=1.0),
            ),
            dict(
                type="Shared2FCBBoxHead",
...
seed = 42
gpu_ids = [0]
work_dir = "./save_dir/htc_x101_64x4d_fpn_dconv_c3-c5_mstrain_400_1400_16x1_20e_coco_no_seg_with_focal"
