...
lr_config = dict(policy="step", warmup="linear", warmup_iters=500, warmup_ratio=0.001, step=[11, 14])
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            type="WandbLoggerHook", init_kwargs=dict(project="pstage-3-od", name="htc_x101_64x4d_fpn_dconv_c3-c5_mstrain_400_1400_16x1_20e_coco_all_data")
        ),
    ],
)
...
seed = 42
gpu_ids = [0]
work_dir = "./save_dir/htc_x101_64x4d_fpn_dconv_c3-c5_mstrain_400_1400_16x1_20e_coco_all_data_instaboost"
