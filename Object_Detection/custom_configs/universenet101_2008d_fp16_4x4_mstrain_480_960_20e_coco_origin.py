model = dict(
    ...
    test_cfg=dict(nms_pre=1000, min_bbox_size=0, score_thr=0.05, nms=dict(type="nms", iou_threshold=0.6), max_per_img=100),
)
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", init_kwargs=dict(project="pstage-3-od", name="universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco")),
    ],
)
custom_hooks = [dict(type="NumClassCheckHook")]
dist_params = dict(backend="nccl")
log_level = "INFO"
load_from = "/opt/ml/pstage_3/mmdetection/pretrained/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco.pth"
resume_from = None
workflow = [("train", 1)]
seed = 42
gpu_ids = [0]
work_dir = "./save_dir/universenet101_2008d_fp16_4x4_mstrain_480_960_20e_coco"
