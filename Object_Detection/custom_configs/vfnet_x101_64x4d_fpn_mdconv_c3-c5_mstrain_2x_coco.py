...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", init_kwargs=dict(project="pstage-3-od", name="vfnet_x101_64x4d_fpn_mdconv_c3-c5_mstrain_2x_coco")),
    ],
)
custom_hooks = [dict(type="NumClassCheckHook")]
dist_params = dict(backend="nccl")
log_level = "INFO"
load_from = "/opt/ml/pstage_3/mmdetection/pretrained/vfnet_x101_64x4d_fpn_mdconv_c3-c5_mstrain_2x_coco.pth"
resume_from = None
workflow = [("train", 1)]
model = dict(
    type="VFNet",
...
seed = 42
gpu_ids = [0]
work_dir = "./save_dir/vfnet_x101_64x4d_fpn_mdconv_c3-c5_mstrain_2x_coco"
