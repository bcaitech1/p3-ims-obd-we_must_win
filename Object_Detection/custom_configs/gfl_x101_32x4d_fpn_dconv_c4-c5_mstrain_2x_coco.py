...
train_pipeline = [
    ...
    dict(type="Resize", img_scale=[(1333, 480), (1333, 800)], multiscale_mode="range", keep_ratio=True),
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type="WandbLoggerHook", init_kwargs=dict(project="pstage-3-od", name="gfl_x101_32x4d_fpn_dconv_c4-c5_mstrain_2x_c")),
    ],
)
custom_hooks = [dict(type="NumClassCheckHook")]
dist_params = dict(backend="nccl")
log_level = "INFO"
load_from = "/opt/ml/pstage_3/mmdetection/pretrained/gfl_x101_32x4d_fpn_dconv_c4-c5_mstrain_2x_coco.pth"
resume_from = None
workflow = [("train", 1)]
model = dict(
    type="GFL",
    ...
    neck=dict(type="FPN", in_channels=[256, 512, 1024, 2048], out_channels=256, start_level=1, add_extra_convs="on_output", num_outs=5),
    bbox_head=dict(
        type="GFLHead",
        num_classes=11,
        in_channels=256,
...
seed = 42
gpu_ids = [0]
work_dir = "./save_dir/gfl_x101_32x4d_fpn_dconv_c4-c5_mstrain_2x_coco"
